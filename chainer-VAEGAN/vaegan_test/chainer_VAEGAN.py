...
df_col = ['epoch', 'enc_loss', 'dec_loss', 'dis_loss', 'GAN_loss', 'like_loss', 'prior_loss']
...
for epoch in six.moves.range(1, n_epoch + 1):
    ...
    df_tmp = pd.DataFrame([[epoch, sum_enc_loss, sum_dec_loss, sum_dis_loss, sum_gan_loss, sum_like_loss, sum_prior_loss]], columns=df_col)
